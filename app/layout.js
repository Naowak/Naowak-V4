  ...
  return (
    <html lang="en">
      <body className={inter.className}>
          ...
          <div className='xl:fixed xl:w-1/5 xl:p-10'>
            <div className='bg-white rounded-xl overflow-hidden shadow-2xl'>
              ...
              <div className='p-2'>
                ...
                <h2 className='text-sm text-center font-medium text-slate-500  p-0.5'>Doctorant en Intelligence Artificielle</h2>
          ...
          {/* Articles */}
          <div className='absolute xl:w-4/5 xl:right-0 xl:p-10'>
